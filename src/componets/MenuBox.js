...
const MenuBox = ({ select, onOptionClick }) => {
  return (
    ...
    >
    <path d="M60.2897 117.168C7.96066 108.767 0.0387385 80.3829 0.0387224 58.6714C-1.2668 25.0009 30.7642 9.61002 46.9428 6.12338C79.3284 -2.95363 146.341 -1.07475 173.764 6.12338C221.412 18.6301 221.36 53.389 219.384 70.157C217.906 82.7027 206.452 110.756 159.525 117.168C121.984 122.297 77.7261 119.305 60.2897 117.168Z" fill="#FFEEA0"
    />
